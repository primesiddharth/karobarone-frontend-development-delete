...
import { Heart, ShoppingCart, Package, CreditCard, Menu, X, ChevronRight } from "lucide-react";
...
export function CommerceShell({ children, title, eyebrow }: { children: React.ReactNode; title: string; eyebrow: string }) {
